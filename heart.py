...
def insert(time, name,last_name, heartrate):
    # Crear un nuevo registro de pulsaciones
    pulsaciones = HeartRate(time=time, name=name, apell=last_name, value=heartrate)
...
def report(limit=0, offset=0):
    ...
    for result in query:
        ...
        json_result['last_name'] = pulsaciones.apell
